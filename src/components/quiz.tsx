    ...
    return (
      <div className="min-h-screen flex flex-col gap-6 items-center justify-center p-10 *:max-w-md text-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <h1 className="text-3xl text-on font-serif mb-0.5">{percentage}</h1>
          <p className="text-lg text-on-subtle font-serif">
            {score} of {questions.length} correct
          </p>
        </div>

        <p className="text-lg paragraph-text text-on-subtle mb-2">
          You answered all {questions.length} questions at {wps * 60} WPM! {percentageNumeric < 0.5 && (<span>But we don’t actually
            think you understand what you read 😔</span>)}
        </p>
